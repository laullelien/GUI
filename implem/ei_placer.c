...
void ei_impl_placer_run(ei_widget_t widget)
{
    ...
    //widget->screen_location.top_left.x = widget->placer_params->rel_x*parent_rect.size.width + widget->placer_params->x + widget->screen_location.top_left.x
    ...
    printf("widgethhhhh %i %i\n", widget->placer_params->width, widget->placer_params->height);
