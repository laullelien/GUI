...
int main(int argc, char* argv[])
{
	...
	const ei_rect_t rect1 = {(ei_point_t) {10,10}, (ei_size_t) {100,100}};
	const ei_rect_t rect2 = {(ei_point_t) {20,20}, (ei_size_t) {200,200}};
	const ei_rect_t rect3 = {(ei_point_t) {30,30}, (ei_size_t) {300,300}};
